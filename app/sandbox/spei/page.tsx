...
export default function SpeiSandboxPage() {
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="space-y-2">
          ...
          >
            <ChevronLeft className="h-4 w-4" /> Volver a Mis Productos
          </button>
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-900">SPEI / Cuenta IFPE</h1>
              <div className="flex items-center gap-2 mt-0.5">
                <Badge className="bg-amber-100 text-amber-700 border-amber-200 text-xs">Entorno Sandbox</Badge>
        ...
        {intentDeclared && (
          <Badge className="bg-emerald-50 text-emerald-700 border-emerald-200 px-4 py-2">
            <CheckCircle2 className="h-4 w-4 mr-1.5" /> Intención declarada
          </Badge>
        )}
      </div>

      <div className="grid lg:grid-cols-3 gap-6">
        {/* Left: Features + API Keys */}
        <div className="space-y-6">
          {/* Features */}
          <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-3">
            <h3 className="font-semibold text-slate-900 text-sm">Capacidades incluidas</h3>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold text-slate-900 text-sm">Credenciales Sandbox</h3>
            </div>
            ...
            <p className="text-xs text-slate-500">
              Header: <code className="bg-slate-100 px-1 rounded font-mono">X-Monato-Environment: sandbox</code>
            </p>
          </div>
